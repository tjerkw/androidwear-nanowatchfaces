...
class GradientClockworkView extends AbstractClockworkView {
    ...
    protected void onDraw(Canvas c) {
        ...
        clockCanvas.drawHand(cal.get(Calendar.MINUTE), 60, radius - 27, 25, MINUTE_PAINT);
        clockCanvas.drawHand(cal.get(Calendar.HOUR), 12, (int)(radius/1.8f), 5, HOUR_PAINT);
        clockCanvas.drawHand(cal.get(Calendar.SECOND), 60, radius-20, 5, SECOND_PAINT);
        ...
        c.drawCircle(0f, 0f, 5, HOUR_PAINT);


        c.drawCircle(0f, 0f, 2, MINUTE_PAINT);
